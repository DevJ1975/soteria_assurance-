 ...
 * per-segment layouts — because `AuthProvider` initializes Supabase on mount.
 * If the public Supabase config is missing from the build, that init throws,
