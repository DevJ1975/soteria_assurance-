...
/**
 * ISO 14001:2015 clause dataset — PLACEHOLDER.
 *
 * Intentionally empty. ISO 14001 is registered as a roadmap standard so that
 ...
 * `isAvailable` to `true` in `../iso14001/index.ts`. No refactor, no migration,
